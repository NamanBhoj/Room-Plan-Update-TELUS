...
namespace SilverTau.Sample
{
    public class ARViewer : MonoBehaviour
    {
        ...
        /// <summary>
        /// A function that allows you to change the RoomPlanObject prefab when loading an AR.
        /// </summary>
        ...
        public void OpenAR()
        {
            ...
            //If you are using the XR solution of RoomPlan for Unity Kit, you do not need to run the scan in manual mode.
            //The scan will automatically start when the ARSession (ARFoundation) is enabled.
            if (!RoomPlanUnityKit.CurrentRoomPlanUnityKitSettings.isCustomXREnabled)
            {
        ...
        /// <summary>
        /// A function that pauses/resumes CaptureSession scanning.
        /// </summary>
        ...
        /// <summary>
        /// A function that performs the action of scanning a new room in one AR session. (Only iOS 17+)
        /// </summary>
        public void CreateNewRoomCaptureSession()
        {
            roomPlanUnityKit.CreateNewRoomCaptureSession();
        }
